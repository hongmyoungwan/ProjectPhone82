...
<form name="myform" action="MemberAddServlet" onsubmit="">
<p style="font-size:12px; color:blue; margin-top:-2px; margin-left:10px;">*는 필수입력사항입니다.</p>
<table border=1>
 <tr>
  <th>*아이디</th>
  <td colspan="3"><input type="text" name="userid" id="userid" placeholder="*아이디" ><div></div><div id="resultCheckID"></div></td>
 </tr>
 <tr>
  <th>*비밀번호</th>
